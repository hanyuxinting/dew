...
*/
(function(i){typeof define==="function"?define([],i):i(null,this.Cookie={})})(function(i,g){function h(b){return typeof b==="string"}function j(b){if(!(h(b)&&b!==""))throw new TypeError("Cookie name must be a non-empty string");}function k(b){return b}g.version="1.0.0";g.get=function(b,a){j(b);var a=typeof a==="function"?{converter:a}:a||{},c=a.converter||k,f,d,e=document.cookie;if(h(e)&&(d=e.match(RegExp("(?:^| )"+b+"(?:(?:=([^;]*))|;|$)"))))f=c(d[1]?d[1]:"");return f};g.set=function(b,a,c){j(b);
